function [ U,metric,C0,C1,P0,P1,A_C,soft_in,soft_pm,llr_v,spaceP0,spaceP1,spaceC0,spaceC1,space_act] = SCL_decoder_two(C0,C1,P0,P1,activePath,inactivePathIndices,A_C,L,U,free1,seg_position,seg,soft_in,soft_pm,llr_v,spaceP0,spaceP1,spaceC0,spaceC1,space_act)
N = length(P1(1,:,1));
n = log2(N);
%U = zeros(L,N);
Code = zeros(L,N);
...
spaceC0{1,seg+1}=C0;
spaceC1{1,seg+1}=C1; 
space_act(seg+1,:)=activePath;

for phi=segment(seg):segment(seg+1)-1        %%递归计算概率
